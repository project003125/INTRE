...
CHAPTER_MAP = [
    ...
    (r"附录E\s", "app-e.html", "附录", "E 跨学校映射", "附录E"),
    (r"附录F\s", "app-f.html", "附录", "F 逻辑指纹", "附录F"),
    (r"附录G\s", "app-g.html", "附录", "G 术语对照", "附录G"),
    (r"附录H\s", "app-h.html", "附录", "H 形式审查", "附录H"),
    (r"附录I\s", "app-i.html", "附录", "I 抽象", "附录I"),
    (r"附录J\s", "app-j.html", "附录", "J 完整目录", "附录J"),
    (r"附录K\s", "app-k.html", "附录", "K 合并稿", "附录K"),
    (r"附录L\s", "app-l.html", "附录", "L 后记", "附录L"),
